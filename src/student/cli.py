...
from student.evaluation import evaluate as evaluate_results
...
from student.retrieval import load_index, search as run_search, search_full
...
def answer_dataset_command(
    ...
    for result in tqdm(
        ...
        generated = generate_answer(result.question_str, context)
        answers.append(
            MinimalAnswer(
